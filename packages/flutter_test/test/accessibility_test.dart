...
void main() {
  ...
  group('custom minimum contrast guideline', () {
    Widget _icon(
        {IconData icon = Icons.search, Color color, Color background}) {
      return Container(
    ...
    testWidgets('Black icons on white background', (WidgetTester tester) async {
      ...
      await expectLater(tester,
          meetsGuideline(CustomMinimumContrastGuideline(finder: _findIcons)));
    });
    ...
    testWidgets('Black icons on black background', (WidgetTester tester) async {
      ...
      await expectLater(
          ...
          doesNotMeetGuideline(
              CustomMinimumContrastGuideline(finder: _findIcons)));
    });
    ...
    testWidgets('Guideline ignores widgets of other types',
      ...
      await expectLater(
          tester,
          doesNotMeetGuideline(
              CustomMinimumContrastGuideline(finder: _findTexts)));
      await expectLater(
          tester,
          doesNotMeetGuideline(
              CustomMinimumContrastGuideline(finder: _findIconsAndTexts)));
    });
    ...
    testWidgets('Custom minimum ratio - Icons', (WidgetTester tester) async {
      ...
      await expectLater(
          ...
          meetsGuideline(CustomMinimumContrastGuideline(
              finder: _findIcons, minimumRatio: 3.0)));
    });
    ...
    testWidgets('Custom minimum ratio - Texts', (WidgetTester tester) async {
      ...
      await expectLater(
          tester,
          meetsGuideline(CustomMinimumContrastGuideline(
              finder: _findTexts, minimumRatio: 3.0)));
    });
